            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('account::edit', $account->id) }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="form-control password-field" name="password" value="{{ $account->password }}">
